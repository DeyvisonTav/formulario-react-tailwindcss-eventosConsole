  ...
  return (
    <div  className='w-80  '>
      ...
      onSubmit={handleSubmitFomr}>
        <div>
          <label 
          className='block text-base text-white mb-1'
        ...
        <div>
          <button className='w-full text-sm bg-black hover:bg-gray-900 transition duration-150 ease-out hover:ease-in px-4 py-1 rounded text-white shadow ' 
          onSubmit={handleSubmitFomr}>
            enviar
          </button>
        </div>
